...
export default function DashboardTopAppBar({ user }) {
  ...
  return (
    <header className="bg-surface fixed top-0 left-0 right-0 md:left-72 z-50 border-b border-outline-variant shadow-sm shadow-secondary-container/5 h-16">
      <div className="h-full flex items-center justify-between px-margin-mobile md:px-lg">
        <Link to="/dashboard" className="md:hidden flex items-center gap-sm">
          <img
            src="/logo.png"
            alt=""
            aria-hidden="true"
